...
The use-case is microcontrollers, which have some boot/factory firmware
where they want **non-volatile locking**, and some A/B firmware, graphics
assets, coredumps, etc that wants **volatile locking**. But allowing
upgrades to those.
